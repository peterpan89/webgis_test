L.TileLayer.BetterWMS = L.TileLayer.WMS.extend({
  ...
  showGetFeatureInfo: function (err, latlng, content) {
	...
	selected_layer = params.layers;
    console.log(selected_layer);
    t1=content;
	var noidung='';
    if(selected_layer=='hocwebgis:thuadat_duynghia'){
		...
		if(img_path!=null){
			noidung+='<hr><img src="images/thuadat/'+img_path+'" width="300px">';
		}
	}
	else if(selected_layer=='hocwebgis:vn_tinh'){
		
		var tentinh=t1.features[0].properties.ten_vi;
		
		noidung+='<h2>Thông tin tỉnh</h2>';
		noidung+='<hr>';
		noidung+='<b>Tỉnh: </b>: '+tentinh+'<br>';
	}
